<x-admin-layout :title="'Añadir Jugador'">
    ...
    <div class="space-y-8" x-data="playerForm()">
        ...
        <div class="bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-700 rounded-2xl p-8 text-white shadow-2xl relative overflow-hidden">
            ...
            <div class="relative z-10">
                <div class="flex items-center">
                    ...
                    <div>
                        <h1 class="text-3xl font-bold">Añadir Nuevo Jugador</h1>
                        <p class="text-blue-100 mt-1">Complete la información del jugador para agregarlo a la plantilla</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="flex items-center text-sm text-gray-500">
            ...
            <i class="fas fa-chevron-right mx-2 text-gray-400"></i>
            <span class="text-gray-900 font-medium">Nuevo Jugador</span>
        </div>
                ...
                <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <select name="team_id" 
                                id="team_id" 
                                required
                                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all @error('team_id') border-red-500 @enderror">
                    ...
                    <div>
                        ...
                        <input type="date" 
                               ...
                               max="{{ date('Y-m-d') }}"
                               class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all @error('birth_date') border-red-500 @enderror">
                        @error('birth_date')
                            <p class="mt-1 text-sm text-red-600 flex items-center">
                                <i class="fas fa-exclamation-circle mr-1"></i>
                                {{ $message }}
                        ...
                        @enderror
                        <p class="mt-1 text-sm text-gray-500">La edad se calculará automáticamente</p>
                    </div>
                </div>
            </div>
                ...
                <div class="p-6 grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div>
                        ...
                        <input type="number" 
                               ...
                               min="0"
                               max="99"
                               class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all @error('jersey_number') border-red-500 @enderror"
                               placeholder="Ej: 10">
                        @error('jersey_number')
                            <p class="mt-1 text-sm text-red-600 flex items-center">
                                <i class="fas fa-exclamation-circle mr-1"></i>
                    ...
                    <div>
                        ...
                        <select name="position" 
                                id="position" 
                                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all @error('position') border-red-500 @enderror">
                            <option value="">Seleccionar posición...</option>
                            <option value="Portero" {{ old('position') == 'Portero' ? 'selected' : '' }}>Portero</option>
                            <option value="Defensa" {{ old('position') == 'Defensa' ? 'selected' : '' }}>Defensa</option>
                            <option value="Mediocampo" {{ old('position') == 'Mediocampo' ? 'selected' : '' }}>Mediocampo</option>
                    ...
                    <div>
                        ...
                        <input type="number" 
                               ...
                               value="{{ old('goals', 0) }}"
                               min="0"
                               class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all @error('goals') border-red-500 @enderror"
                               placeholder="0">
                        @error('goals')
                            <p class="mt-1 text-sm text-red-600 flex items-center">
                                <i class="fas fa-exclamation-circle mr-1"></i>
                    ...
                    <div>
                        ...
                        <input type="number" 
                               ...
                               value="{{ old('assists', 0) }}"
                               min="0"
                               class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all @error('assists') border-red-500 @enderror"
                               placeholder="0">
                        @error('assists')
                            <p class="mt-1 text-sm text-red-600 flex items-center">
                                <i class="fas fa-exclamation-circle mr-1"></i>
                    ...
                    <div class="flex flex-col md:flex-row items-start md:items-center gap-6">
                        ...
                        <div class="flex-1 w-full">
                            ...
                            <input type="file" 
                                   ...
                                   class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:text-sm file:font-semibold file:bg-blue-50 file:text-blue-700 hover:file:bg-blue-100 @error('photo_url') border-red-500 @enderror">
                            @error('photo_url')
                                <p class="mt-1 text-sm text-red-600 flex items-center">
                                    <i class="fas fa-exclamation-circle mr-1"></i>
                                    {{ $message }}
            ...
            <div class="bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-100">
                <div class="p-6">
                    <div class="flex flex-col sm:flex-row justify-end gap-4">
                        ...
                        <button type="submit" 
                                class="inline-flex items-center justify-center px-6 py-3 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white font-semibold rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105">
